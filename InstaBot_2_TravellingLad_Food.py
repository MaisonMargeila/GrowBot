...
class instabot():
    ...
    def login(self):
        try:
            ...
            sleep(1)
            self.driver.find_element_by_xpath("/html/body/div[1]/section/main/article/div[2]/div[1]/div/form/div[2]/div/label/input").send_keys("travelling.lad")
            sleep(1)
            self.driver.find_element_by_xpath("/html/body/div[1]/section/main/article/div[2]/div[1]/div/form/div[3]/div/label/input").click()
            sleep(1)
            self.driver.find_element_by_xpath("/html/body/div[1]/section/main/article/div[2]/div[1]/div/form/div[3]/div/label/input").send_keys("Japan@786")
            sleep(3)
    ...
    def like_popular_feeds(self):
        ...
        try:
            ...
            #print(hash_tag)
            self.driver.get("https://www.instagram.com/explore/tags/foodblogger")
            sleep(5)
    ...
    def comment_feeds(self):
        ...
        try:
            ...
            try:
                ...
                self.driver.find_element_by_xpath("/html/body/div[1]/section/main/div/div/article/div[2]/section[3]/div/form/textarea").send_keys("This is so delicious 😍")
                sleep(1)
    ...
    def comment_popular_feeds(self):
        ...
        try:
            ...
            try:
                ...
                sleep(1)
                print("Writing Comment")
                self.driver.find_element_by_xpath("/html/body/div[4]/div[2]/div/article/div[2]/section[3]/div/form/textarea").send_keys("This is so delicious 😍")
                sleep(1)
                print("Hitting Post Button")
...
for _ in range(4):
    ...
    for _ in range(5):
        bot.comment_popular_feeds() #3 comments
    sleep(60)
